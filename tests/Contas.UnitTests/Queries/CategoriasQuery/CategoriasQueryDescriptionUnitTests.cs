...
{
    public class CategoriasQueryDescriptionUnitTests
    {
        [Theory, AutoMoqDataAttribute]
        public void Deve_Validar_A_Descricao_Da_Query_De_Categorias(CategoriasQuery qry)
        {
            var query = CategoriasQueryDescription.Criar(qry).Value;
