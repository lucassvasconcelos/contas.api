...
{
    public class ContasQueryDescriptionUnitTests
    {
        [Theory, AutoMoqDataAttribute]
        public void Deve_Validar_A_Descricao_Da_Query_De_Contas(ContasQuery qry)
        {
            var query = ContasQueryDescription.Criar(qry).Value;
